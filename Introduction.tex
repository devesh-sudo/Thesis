...
In this subsection we will prove that blowing up of second fundamental form is the only obstruction for continuing the flow. The proof goes by contradiction, relying on the Bernstein-Bando-Shi estimates. This technique is very similar to the one Hamilton used for Ricci flow \cite{hamilton1982three}.
