...
The Mean Curvature Flow (MCF) is an extrinsic flow that flows the hypersurface immersed %in a fixed ambient Riemannian manifold. It flows the hypersurface 
